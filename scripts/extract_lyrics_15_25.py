...
output_json = r'C:\Users\ACAC\Desktop\アニメ用\vocaloid-ai-event\tmp\lyrics_for_fix_15_25.json'
...
def main():
    ...
    print(f"Extraction complete. {len(results)} tracks (No.15-25) saved to {output_json}")
