...
output_json = r'c:\Users\ACAC\Desktop\アニメ用\vocaloid-ai-event\tmp\lyrics_for_analysis.json'
...
def main():
    ...
    # 引用符内の改行を正しく扱うために csv module を使用
    ...
    print(f"Extraction complete. {len(results)} tracks saved to {output_json}")
