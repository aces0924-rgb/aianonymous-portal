...
export default function SelectionCard({ list, previewQuery, enableArtistMain }: SelectionCardProps) {
      ...
      <div className="relative z-10 space-y-5 flex flex-col h-full">
        ...
        <div className="space-y-1">
          <h2 className={`text-xl md:text-2xl font-black tracking-tighter leading-tight transition-colors duration-500 ${
            ...
            {list.userName} <span className="text-sm font-bold opacity-60">さんの推し{enableArtistMain ? 'アーティスト' : '曲'}リスト</span>
          </h2>
        </div>
