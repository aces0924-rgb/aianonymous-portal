  ...
  return (
    ...
    >
      <div className="shrink-0">
        {variant === 'hero' ? (
          <svg className="w-8 h-8 md:w-10 md:h-10 text-[var(--color-cyan-400)]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
