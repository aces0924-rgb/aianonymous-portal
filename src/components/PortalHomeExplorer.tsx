...
export default function PortalHomeExplorer({
  ...
  return (
    <div className="space-y-8">
      <div className="bg-gradient-to-r from-cyan-600/90 via-sky-500/90 to-emerald-400/90 text-white border-y border-white/20 shadow-[0_8px_30px_rgba(14,165,233,0.22)] backdrop-blur-md">
        <div className="max-w-5xl mx-auto px-4 py-4 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:items-center">
            <div className="inline-flex rounded-full bg-white/20 border border-white/25 p-1 shadow-inner backdrop-blur-sm">
              <button
                type="button"
