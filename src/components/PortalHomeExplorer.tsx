...
export default function PortalHomeExplorer({
  ...
  return (
    <div className="space-y-8">
      <div className="bg-black/90 text-white border-y border-white/10 shadow-[0_8px_30px_rgba(0,0,0,0.35)]">
        <div className="max-w-5xl mx-auto px-4 py-4 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div className="space-y-1">
            <p className="text-[10px] md:text-xs uppercase tracking-[0.45em] text-white/50">Portal Events</p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:items-center">
            <div className="inline-flex rounded-full bg-white/10 border border-white/10 p-1">
              <button
                ...
                className={`px-4 md:px-6 py-2 rounded-full text-[11px] md:text-sm font-black tracking-widest transition-all ${
                  view === 'active' ? 'bg-white text-black shadow-lg' : 'text-white/70 hover:text-white'
                }`}
              >
                開催前・開催中 ({activeCount})
              </button>
              <button
                ...
                className={`px-4 md:px-6 py-2 rounded-full text-[11px] md:text-sm font-black tracking-widest transition-all ${
                  view === 'past' ? 'bg-white text-black shadow-lg' : 'text-white/70 hover:text-white'
                }`}
              >
                過去 ({pastCount})
              </button>
            ...
            <a
              href="#event-calendar"
              className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-full bg-white text-black font-black tracking-widest hover:bg-zinc-200 transition-colors shadow-lg"
            >
